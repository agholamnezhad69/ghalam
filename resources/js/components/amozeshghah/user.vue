                                        ...
                                        <div class="branch-add">
                                            ...
                                            <b-col md="7">
                                                <v-select
                                                    ...
                                                    :selectable="option =>  option.parent > 0 && option.parent"
                                                    label="title"/>
...
export default {
    ...
    methods: {
        ...
        selectTab(page = 1) {
            ...
            axios.get("/amozeshghah/user_get?page=" + page).then(response => {
        ...
        get_branch_func(userId) {
            ...
            axios
                .post("/amozeshghah/get_branches_of_amozeshghah", {
                    userId: this.userId,
                })
                .then(response => {
                    ...
                    var arr = response.data.amozeshgah.sub
        ...
        saveUserBranchAccess() {
            axios
                .post("/amozeshghah/user_access_branch", {
                    userId: this.userId,
