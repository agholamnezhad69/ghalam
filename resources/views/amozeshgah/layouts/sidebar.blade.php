...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                <router-link class="nav-item" to="/amozeshghah_branch">
                    <i class="feather icon-git-branch"></i>
            ...
            <li class=" nav-item">
                <router-link class="nav-item" to="/amozeshghah_user">
                    <i class="feather icon-git-branch"></i>
                    <span class="menu-title" data-i18n="Dashboard">تعریف کاربر</span>
                    <span class="badge badge badge-warning badge-pill float-right mr-2">2</span>
